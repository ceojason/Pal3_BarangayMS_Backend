...
public class LoginController {
    ...
    public LoginController(LoginService loginService, LoginJDBCRepository loginJDBCRepository, SystemAdminJDBCRepository systemAdminJDBCRepository) {
        this.loginService = loginService;
        this.loginJDBCRepository = loginJDBCRepository;
        this.systemAdminJDBCRepository = systemAdminJDBCRepository;
    }
